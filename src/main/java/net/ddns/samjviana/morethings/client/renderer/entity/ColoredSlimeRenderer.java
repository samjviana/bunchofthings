package net.ddns.samjviana.morethings.client.renderer.entity;

import com.mojang.blaze3d.matrix.MatrixStack;

import net.ddns.samjviana.morethings.client.renderer.entity.layers.ColoredSlimeGelLayer;
...
public class ColoredSlimeRenderer extends MobRenderer<ColoredSlimeEntity, SlimeModel<ColoredSlimeEntity>> {
    private static final ResourceLocation COLORED_SLIME_TEXTURES = new ResourceLocation("morethings:textures/entity/colored_slime/colored_slime.png");
