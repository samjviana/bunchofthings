...
public class ColoredPistonStructureResolver {
    ...
    public ColoredPistonStructureResolver(Level p_60418_, BlockPos p_60419_, Direction p_60420_, boolean p_60421_) {
        this.level = p_60418_;
    ...
    public boolean resolve() {
        ...
        if (!ColoredStickyPistonBlock.isPushable(blockstate, this.level, this.startPos, this.pushDirection, false, this.pistonDirection)) {
    ...
    private boolean addBlockLine(BlockPos p_60434_, Direction p_60435_) {
        ...
        if (level.isEmptyBlock(p_60434_)) {
            return true;
        } else if (!ColoredStickyPistonBlock.isPushable(blockstate, this.level, p_60434_, this.pushDirection, false, p_60435_)) {
            return true;
            ...
            if (i + this.toPush.size() > 12) {
                ...
                if (blockstate.isAir() || !(oldState.canStickTo(blockstate) && blockstate.canStickTo(oldState)) || !ColoredStickyPistonBlock.isPushable(blockstate, this.level, blockpos, this.pushDirection, false, this.pushDirection.getOpposite()) || blockpos.equals(this.pistonPos)) {
                    break;
                }
                ...
                if (!ColoredStickyPistonBlock.isPushable(blockstate, this.level, blockpos1, this.pushDirection, true, this.pushDirection) || blockpos1.equals(this.pistonPos)) {
                    return false;
                }
