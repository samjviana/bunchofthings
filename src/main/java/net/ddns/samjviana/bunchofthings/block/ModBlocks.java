...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> COLORED_STICKY_PISTON = BLOCKS.register("colored_sticky_piston", () -> createColoredStickyPiston());
    ...
    private static ColoredStickyPistonBlock createColoredStickyPiston() {
        ...
        return new ColoredStickyPistonBlock(true, AbstractBlock.Properties.create(Material.PISTON).hardnessAndResistance(1.5F).func_235828_a_(ModBlocks::func_235436_b_).func_235842_b_(abstractblock$ipositionpredicate).func_235847_c_(abstractblock$ipositionpredicate));
    }
    ...
    public static void registerStickyPistons() {
        for (int i = 0; i < Colors.values().length; i++) {
            ...
            BunchOfThings.LOGGER.debug(color.toString());
